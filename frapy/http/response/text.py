...
from frapy.utils.python import memoizemethod_noargs, to_unicode
...
class TextResponse(Response):
    ...
    def follow(
        ...
        * a relative URL
        * a :class:`~frapy.link.Link` object, e.g. the result of
          :ref:`topics-link-extractors`
        * a :class:`~frapy.selector.Selector` object for a ``<link>`` or ``<a>`` element, e.g.
          ``response.css('a.my_link')[0]``
        * an attribute :class:`~frapy.selector.Selector` (not SelectorList), e.g.
