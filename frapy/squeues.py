...
from frapy.utils.deprecate import create_deprecated_class
...
PickleFifoDiskQueue = _frapy_serialization_queue(_PickleFifoSerializationDiskQueue)
PickleLifoDiskQueue = _frapy_serialization_queue(_PickleLifoSerializationDiskQueue)
MarshalFifoDiskQueue = _frapy_serialization_queue(_MarshalFifoSerializationDiskQueue)
MarshalLifoDiskQueue = _frapy_serialization_queue(_MarshalLifoSerializationDiskQueue)
FifoMemoryQueue = _frapy_non_serialization_queue(queue.FifoMemoryQueue)
LifoMemoryQueue = _frapy_non_serialization_queue(queue.LifoMemoryQueue)
