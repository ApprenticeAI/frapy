...
def request_fingerprint(
    ...
    if include_headers or keep_fragments:
        message = (
            ...
            "frapy.utils.request.fingerprint() function instead.\n"
            "\n"
...
class RequestFingerprinter:
    ...
    <frapy.http.Request.url>` and the values of :attr:`request.method
    <frapy.http.Request.method>` and :attr:`request.body
    <frapy.http.Request.body>`. It then generates an `SHA1
...
def request_from_dict(d: dict, *, spider: Optional[Spider] = None) -> Request:
    """Create a :class:`~frapy.Request` object from a dict.
