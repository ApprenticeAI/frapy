...
from frapy.core.downloader.handlers.http11 import TunnelError
from frapy.exceptions import NotConfigured
from frapy.http.request import Request
from frapy.spiders import Spider
from frapy.utils.python import global_object_name
from frapy.utils.response import response_status_message
...
def get_retry_request(
    ...
    *,
    ...
    """
    Returns a new :class:`~frapy.Request` object to retry the specified
    request, or ``None`` if retries of the specified request have been
    exhausted.

    For example, in a :class:`~frapy.Spider` callback, you could use it as
    follows::
    ...
    *spider* is the :class:`~frapy.Spider` instance which is asking for the
