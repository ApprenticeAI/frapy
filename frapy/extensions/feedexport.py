...
from frapy.utils.ftp import ftp_store_file
from frapy.utils.log import failure_to_exc_info
from frapy.utils.misc import create_instance, load_object
from frapy.utils.python import get_func_args, without_none_values
        ...
        for uri_template, values in self.feeds.items():
            if values["batch_item_count"] and not re.search(
                ...
                logger.error(
                    ...
                    "https://docs.frapy.org/en/latest/topics/feed-exports.html#feed-export-batch-item-count",
                    uri_template,
                )
                return False
        return True
