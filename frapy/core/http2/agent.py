...
from frapy.core.downloader.contextfactory import AcceptableProtocolsContextFactory
from frapy.core.http2.protocol import H2ClientFactory, H2ClientProtocol
