...
class BaseScheduler(metaclass=BaseSchedulerMeta):
    ...
    * Downloader middleware: ``process_request``, ``process_response`` and ``process_exception`` methods
    ...
    def from_crawler(cls, crawler: Crawler):
        """
        Factory method which receives the current :class:`~frapy.crawler.Crawler` object as argument.
        """
        return cls()
    ...
    def open(self, spider: Spider) -> Optional[Deferred]:
        ...
        :type spider: :class:`~frapy.spiders.Spider`
        """
        pass
    ...
    def next_request(self) -> Optional[Request]:
        """
        Return the next :class:`~frapy.http.Request` to be processed, or ``None``
...
class Scheduler(BaseScheduler):
    ...
    :type dupefilter: :class:`frapy.dupefilters.BaseDupeFilter` instance or similar:
    ...
    :type stats: :class:`frapy.statscollectors.StatsCollector` instance or similar:
    ...
    :type crawler: :class:`frapy.crawler.Crawler`
    """
    ...
    def next_request(self) -> Optional[Request]:
        """
        Return a :class:`~frapy.http.Request` object from the memory queue,
