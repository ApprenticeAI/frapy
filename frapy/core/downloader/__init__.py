...
from frapy.core.downloader.middleware import DownloaderMiddlewareManager
from frapy.resolver import dnscache
from frapy.utils.defer import mustbe_deferred
