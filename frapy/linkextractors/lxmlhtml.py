...
from frapy.linkextractors import (
    IGNORED_EXTENSIONS,
    _is_valid_url,
    _matches,
    _re_type,
...
from frapy.utils.misc import arg_to_iter, rel_has_nofollow
from frapy.utils.python import unique as unique_list
from frapy.utils.response import get_base_url
from frapy.utils.url import url_has_any_extension, url_is_from_any_domain
...
class LxmlLinkExtractor:
    ...
    def extract_links(self, response):
        """Returns a list of :class:`~frapy.link.Link` objects from the
        specified :class:`response <frapy.http.Response>`.
