...
class Selector(_ParselSelector, object_ref):
    ...
    ``response`` is an :class:`~frapy.http.HtmlResponse` or an
    :class:`~frapy.http.XmlResponse` object that will be used for selecting
    and extracting data.
    ...
    * ``"html"`` for :class:`~frapy.http.HtmlResponse` type
    * ``"xml"`` for :class:`~frapy.http.XmlResponse` type
