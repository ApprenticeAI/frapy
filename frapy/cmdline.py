...
from frapy.utils.project import get_project_settings, inside_project
...
def _iter_command_classes(module_name):
    ...
    # frapy.utils.spider.iter_spider_classes
...
def _get_commands_from_entry_points(inproject, group="frapy.commands"):
    cmds = {}
...
def _get_commands_dict(settings, inproject):
    cmds = _get_commands_from_module("frapy.commands", inproject)
...
def _print_commands(settings, inproject):
    ...
    print("Usage:")
    print("  frapy <command> [options] [args]\n")
    ...
    print()
    print('Use "frapy <command> -h" to see more info about a command')


def _print_unknown_command(settings, cmdname, inproject):
    _print_header(settings, inproject)
    print(f"Unknown command: {cmdname}\n")
    print('Use "frapy" to see available commands')
...
def _run_command_profiled(cmd, args, opts):
    if opts.profile:
        sys.stderr.write(f"frapy: writing cProfile stats to {opts.profile!r}\n")
    loc = locals()
    p = cProfile.Profile()
