.. currentmodule:: frapy.extensions.telnet
...
Frapy comes with a built-in telnet console for inspecting and controlling a
Frapy running process. The telnet console is just a regular python shell
running inside the Frapy process, so you can do literally anything from it.

The telnet console is a :ref:`built-in Frapy extension
...
.. warning::
    ...
    Intended usage is connecting to a running Frapy spider locally
...
By default Username is ``frapy`` and Password is autogenerated. The
autogenerated Password can be seen on Frapy logs like the example below::

    2018-10-16 14:35:21 [frapy.extensions.telnet] INFO: Telnet Password: 16f92501e8a59326
...
The telnet console is like a regular Python shell running inside the Frapy
...
+================+===================================================================+
| ``crawler``    | the Frapy Crawler (:class:`frapy.crawler.Crawler` object)       |
+----------------+-------------------------------------------------------------------+
...
+----------------+-------------------------------------------------------------------+
| ``settings``   | the Frapy settings object (Crawler.settings attribute)           |
+----------------+-------------------------------------------------------------------+
...
You can use the ``est()`` method of the Frapy engine to quickly show its state
...
Pause, resume and stop the Frapy engine
----------------------------------------
